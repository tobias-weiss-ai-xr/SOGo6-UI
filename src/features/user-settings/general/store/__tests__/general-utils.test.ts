...
describe('mapGeneralSettingsToApi', () => {
  ...
  it('maps language correctly', () => {
    const result = mapGeneralSettingsToApi({
      ...FULL_GENERAL_SETTINGS,
      language: 'de',
    })
...
describe('mapApiToGeneralSettings', () => {
  it('maps all fields correctly', () => {
    expect(mapApiToGeneralSettings(FULL_USER_PREFERENCES as any)).toEqual(
      FULL_GENERAL_SETTINGS
    )
  })
  ...
  it('maps language correctly', () => {
    const result = mapApiToGeneralSettings({
      ...
      USER_GENERAL: {
        ...FULL_USER_PREFERENCES.USER_GENERAL,
        SOGO_U_LANGUAGE: 'es',
      },
    } as any)
  ...
  describe('defaults', () => {
    ...
    it('defaults profilePictureSource to PP_DEFAULT when missing', () => {
      const result = mapApiToGeneralSettings({
        USER_GENERAL: {
          ...FULL_USER_PREFERENCES.USER_GENERAL,
          SOGO_U_PROFILE_PICTURE: undefined,
        },
      } as any)
